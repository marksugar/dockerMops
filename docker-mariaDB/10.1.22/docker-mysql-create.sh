...
curl -Lks4 https://raw.githubusercontent.com/marksugar/dockerMops/master/docker-mariaDB/10.2.15/my.cnf -o ${jpdir}my.cnf
#/usr/bin/docker
curl -Lks4 https://raw.githubusercontent.com/marksugar/dockerMops/master/docker-mariaDB/10.2.15/docker-compose.yaml -o ${jpdir}docker-compose.yaml
