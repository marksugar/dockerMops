...
curl -Lks4 https://raw.githubusercontent.com/LinuxEA-Mark/Docker-MariaDB/master/my.cnf -o ${jpdir}my.cnf
#/usr/bin/docker
curl -Lks4 https://raw.githubusercontent.com/LinuxEA-Mark/Docker-MariaDB/master/docker-compose.yaml -o ${jpdir}docker-compose.yaml
